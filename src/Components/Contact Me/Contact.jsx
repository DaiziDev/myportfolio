...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_wplw6iq', 'template_n2aizhd', formRef.current, {
        publicKey: 'narxgk-uVVuX2qr5a',
      })
      .then(
        () => {
          setSucces(true)
  ...
  const variants = {
    ...
    animate: {
      ...
      transition: {
        duration: 0.5,
        staggerChildrend: 0.1,
      },
    },
  };

  // Here is the return contents
  return (
    <motion.div
      ref={ref}
      id="contact"
    ...
    >
      <motion.div variants={variants} className="textContainer">
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>shadowapex308@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
          <span>237 avenue kennedy</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Contact</h2>
          <span>+237 656 498 660</span>
        </motion.div>
      </motion.div>
        ...
        >
          ...
          >
            ...
            <motion.path
              ...
              strokeWidth="0.5"
              initial={{ pathLength: 0 }}
              animate={isInView && { pathLength: 0.9 }}
              transition={{ duration: 3 }}
